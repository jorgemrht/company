                    ...
                    <div class="panel-body">
                       ...
                       <article class="col-md-12 col-md-offset-2"> 
                        ...
                        <footer class="col-md-12 col-md-offset-1">             
                            ...
                            <asp:Button ID="editUser" runat="server" Text="Guardar cambios" CssClass="btn btn-success col-md-4 col-md-offset-2" OnClick="editUser" OnClientClick="return confirm('¿Estas seguro?');" /> 
                        </footer>
                        <br /><br /><br />
              </div> <!-- panel-heading -->
