<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addUsuario.aspx.cs" Inherits="GestionEmpresas.Privada.addUsuario" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="panel panel-primary text-center col-md-8 col-md-offset-2">
                <div class="panel-heading"> <h1> Añadir Usuario <span class="glyphicon glyphicon-plus"></span></h1></div>
                    <div class="panel-body">
                       ...
                       <article class="col-md-12 col-md-offset-2"> 
                        ...
                        <footer class="col-md-12 col-md-offset-1">             
                            ...
                            <asp:Button ID="btnEnviar" runat="server" Text="Guardar cambios" CssClass="btn btn-success col-md-4 col-md-offset-2" OnClick="addUser" OnClientClick="return confirm('¿Estas seguro?');" /> 
                        </footer>
                        <br /><br /><br />
              </div> <!-- panel-heading -->
